<div id="modx-panel-groups-roles"></div>

<div id="tab-roles" class="padding x-hide-display">
    <h2>{$_lang.roles}</h2>
...
<script type="text/javascript" src="assets/modext/widgets/security/modx.panel.groups.roles.js"></script>
