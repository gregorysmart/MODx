...
<div id="preLoader"><table width="100%" border="0" cellpadding="0"><tbody><tr><td align="center"><div class="preLoaderText">{$_lang.loading_page}</div></td></tr></tbody></table></div>

<div id="modx_container">
<form id="tvsort" name="tvsort" method="post" action="{$_config.connectors_url}element/template.php?action=tvsort">
<input type="hidden" id="sortableVals" name="sortableVals" value="" />
<input type="hidden" name="sortableListsSubmitted" value="true" />
<input type="hidden" name="templateId" value="{$template->id}" />
<input type="submit" name="btnSubmit" style="display:none;" value="Submit" />
</form>
<div class="subTitle">
<br />
