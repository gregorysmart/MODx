...
if (!$modx->hasPermission('new_snippet')) $error->failure($modx->lexicon('permission_denied'));
...
if (!$snippet->save()) $error->failure($modx->lexicon('snippet_err_create'));
...
// log manager action
$modx->logManagerAction('snippet_create','modSnippet',$snippet->id);
