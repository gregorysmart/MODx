...
if (!$modx->hasPermission('new_module')) $error->failure($modx->lexicon('permission_denied'));
...
// log manager action
$modx->logManagerAction('module_create','modModule',$module->id);

// empty cache
$cacheManager= $modx->getCacheManager();
$cacheManager->clearCache();

$error->success('',$module->get(array_diff(array_keys($module->_fields), array('modulecode'))));