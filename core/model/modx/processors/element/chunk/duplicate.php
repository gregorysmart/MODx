...
$newname = isset($_POST['name']) 
    ? $_POST['name']
    : $modx->lexicon('duplicate_of').$old_chunk->name;
    
// duplicate chunk
$chunk = $modx->newObject('modChunk');
$chunk->set('name',$newname);
$chunk->set('description',$old_chunk->description);
$chunk->set('snippet',$old_chunk->snippet);
$chunk->set('category',$old_chunk->category);
$chunk->set('locked',$old_chunk->locked);
if ($chunk->save() === false) {
...
// log manager action
$modx->logManagerAction('chunk_duplicate','modChunk',$chunk->id);
