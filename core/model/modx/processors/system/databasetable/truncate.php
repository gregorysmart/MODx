...
if ($_POST['t'] == '' || !isset($_POST['t'])) $error->failure($modx->lexicon('truncate_table_err'));

if(!$modx->exec('TRUNCATE TABLE `'.$modx->config['dbname'].'`.'.$_POST['t'])) $error->failure($modx->lexicon('truncate_table_err'));
