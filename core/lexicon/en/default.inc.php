...
$_lang['document_opt_show_menu_help'] = 'When enabled the resource will be available for use inside a web menu. Please note that some Menu Builders might choose to ignore this option.';
