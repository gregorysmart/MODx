...
$_lang['create_static_resource_here'] = 'Create static resource here';
$_lang['create_user_group'] = 'Create User Group';
$_lang['create_weblink_here'] = 'Create weblink here';
$_lang['create_symlink_here'] = 'Create symlink here';
...
$_lang['document_alias_help'] = 'An alias for this resource. This will make the resource accessible using:<br /><br />http://yourserver/alias<br /><br /><strong>Note</strong>This only works if you\'re using friendly URLs.';
$_lang['document_content'] = 'Resource Content';
$_lang['document_description'] = 'Description';
$_lang['document_description_help'] = 'This is an optional description of the resource.';
$_lang['document_err_add_to_group'] = 'An error occured while attempting to add the resource to a resource group.';
$_lang['document_err_change_parent_to_folder'] = 'An error occurred while attempting to change the resource\'s parent to a folder.';
$_lang['document_err_delete'] = 'An error occurred while deleting the resource.';
$_lang['document_err_delete_accessperms'] = 'An error occurred while deleting resource access permissions.';
$_lang['document_err_delete_children'] = 'An error occurred while deleting children.';
$_lang['document_err_delete_container_sitestart'] = 'The resource you are trying to delete is a container containing resource %s. This resource is registered as the \'Site start\' resource, and cannot be deleted. Please assign another resource as your \'Site start\' resource and try again.';
$_lang['document_err_delete_container_siteunavailable'] = 'The resource you are trying to delete is a folder containing resource %s. This resource is registered as the \'Site unavailable page\' resource, and cannot be deleted. Please assign another resource as your \'Site unavailable page\' resource and try again.';
$_lang['document_err_delete_sitestart'] = 'The resource is \'Site start\' and cannot be deleted!';
$_lang['document_err_delete_siteunavailable'] = 'The resource is used as the \'Site unavailable page\' and cannot be deleted!';
$_lang['document_err_delete_tv'] = 'An error occurred while deleting resource template variables.';
$_lang['document_err_publish']  = 'An error occurred while trying to publish the resource.';
$_lang['document_err_not_found'] = 'No resource specified!';
$_lang['document_err_not_specified'] = 'No resource specified!';
$_lang['document_err_old_parent_to_doc'] = 'An error occured while attempting to change the old parent to a regular resource.';
$_lang['document_err_own_parent'] = 'The resource cannot be its own parent.';
$_lang['document_err_save'] = 'An error occurred while attempting to save the resource.';
$_lang['document_err_select_parent'] = 'Please select a parent resource.';
$_lang['document_err_undelete_children'] = 'An error occurred while trying to undelete the children of the resource.';
$_lang['document_err_undelete_document'] = 'An error occurred while trying to undelete the resource.';
$_lang['document_err_unpublish'] = 'An error occurred while trying to unpublish the resource.';
$_lang['document_err_unpublish_sitestart'] = 'The resource is linked to the site_start variable and cannot be unpublished!';
$_lang['document_err_unpublish_sitestart_dates'] = 'The resource is linked to the site_start variable and cannot have publish or unpublish dates set!';
...
$_lang['document_long_title_help'] = 'This is a longer title for your resource. It is handy for search engines, and might be more descriptive for the resource.';
...
$_lang['document_opt_emptycache_help'] = 'When enabled this will make MODx empty the cache after you save the resource. This way your visitors will not see an older version of the resource.';
$_lang['document_opt_folder'] = 'Container?';
$_lang['document_opt_folder_help'] = 'When enabled this will make the resource also act as a container for other resources. A \'container\' is like a folder, only it can also have content.';
$_lang['document_opt_menu_index'] = 'Menu index';
$_lang['document_opt_menu_index_help'] = 'Menu Index is a field you can use for sorting resources in your menu snippet(s). You can also use it for any other purpose in your snippets.';
$_lang['document_opt_menu_title'] = 'Menu title';
$_lang['document_opt_menu_title_help'] = 'Menu title is a field you can use to display a short title for the resource inside your menu snippet(s) or modules.';
$_lang['document_opt_published'] = 'Published?';
$_lang['document_opt_published_help'] = 'When published the resource is available to the public immediately after saving it.';
$_lang['document_opt_richtext'] = 'Rich text?';
$_lang['document_opt_richtext_help'] = 'When enabled MODx will use the rich text editor for editing resources. If your resources contain JavaScript and forms, uncheck this to edit in HTML mode and so that the editor doesn\'t mess your documents up.';
$_lang['document_opt_show_menu'] = 'Hide from Menus';
$_lang['document_opt_show_menu_help'] = 'When enabled the resource will <b>not</b> be available for use inside a web menu. Please note that some Menu Builders might choose to ignore this option.';
$_lang['document_opt_trackvisit_help'] = 'Log each visitor\'s visit to this resource.';
$_lang['document_parent'] = 'Resource parent';
$_lang['document_parent_help'] = 'Click on the icon above to enable (or disable) selecting this resource\'s parent. Next, click a document in the tree to set its new parent.';
$_lang['document_setting'] = 'Resource Settings';
$_lang['document_summary'] = 'Summary (introtext)';
$_lang['document_summary_help'] = 'A brief summary of the resource.';
$_lang['document_title'] = 'Title';
$_lang['document_title_help'] = 'The name/title of the resource. Try to avoid using backslashes in the name!';
$_lang['document_to_be_moved'] = 'Resource to be moved';
$_lang['document_weblink_help'] = 'The URL or ID of the resource you wish to reference with this weblink.';
$_lang['document_symlink_help'] = 'The URL or ID of the resource you wish to reference with this symlink.';
...
$_lang['link_attributes_help'] = 'Attributes for the link for this page, such as target= or rel=.';
...
$_lang['manage_workspaces'] = 'Workspaces';
...
$_lang['move_document_to_child_error'] = 'You cannot move a document to one of its children documents.';
$_lang['name'] = 'Name';
...
$_lang['page_data_cacheable_help'] = 'When enabled, the resource will be saved to the cache. If your resource contains snippets, make sure this field is unchecked.';
$_lang['page_data_cached'] = '<strong>Source retrieved from cache:</strong>';
$_lang['page_data_changes'] = 'Changes';
$_lang['page_data_contentType'] = 'Content Type';
$_lang['page_data_contentType_help'] = 'The content type for this resource. If you\'re not sure which content type the resource should have, just leave it as text/html.';
...
$_lang['page_data_publishdate_help'] = 'If you set a publish date, the resource will be published as soon as the publish date is reached. Click on the calendar icon to select a date, or leave it blank to set it so the resource is never automatically published.';
$_lang['page_data_published'] = 'Published';
$_lang['page_data_searchable'] = 'Searchable';
$_lang['page_data_searchable_help'] = 'When enabled, the resource is able to be searched. This setting can also be used for other purposes in your snippets.';
$_lang['page_data_source'] = 'Source';
$_lang['page_data_status'] = 'Status';
$_lang['page_data_template'] = 'Uses template';
$_lang['page_data_template_help'] = 'The template in use by the resource.';
$_lang['page_data_title'] = 'Page data';
$_lang['page_data_unpublishdate'] = 'Un-publish date';
$_lang['page_data_unpublishdate_help'] = 'If you set an unpublish date, the resource will be unpublished as soon as the unpublish date is reached. Click on the calendar icon to select a date, or leave it blank to set it so the resource is never automatically unpublished.';
...
$_lang['policy_management_title'] = 'Access Policies';
...
$_lang['untitled_module'] = 'Untitled module';
...
$_lang['user_group_management_title'] = 'Manage Groups and Roles';
