...
$_lang['tv_lock_msg'] = 'Only Administrators (Role ID 1) can edit this variable.';
...
$_lang['tv_tmpl_access_msg'] = 'Select the templates that are allowed to access/process this variable';
