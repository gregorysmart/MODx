...
$_lang['package_err_nfs'] = 'Could not retrieve package %s.';
$_lang['package_err_ns'] = 'Package not specified.';
$_lang['package_err_remove'] = 'Error removing package with primary key %s';
$_lang['package_err_uninstall'] = 'Error uninstalling package with primary key %s';
...
$_lang['provider_err_nfs'] = 'Provisioner not found with ID %s';
